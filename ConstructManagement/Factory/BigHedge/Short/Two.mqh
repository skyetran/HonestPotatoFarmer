#ifndef TWO_LEVEL_NET_SHORT_BIG_HEDGE_FACTORY_H
#define TWO_LEVEL_NET_SHORT_BIG_HEDGE_FACTORY_H

#include "../../../Construct/BigHedge/Short/Two.mqh"
#include "../../ConstructFactory.mqh"

class TwoLevelNetShortBigHedgeFactory : public ConstructFactory
{
public:
   //--- Constructor
   //--- Call To Register Type
   TwoLevelNetShortBigHedgeFactory(void);
