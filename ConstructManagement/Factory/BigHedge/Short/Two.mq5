...
ConstructFullTradePool *TwoLevelNetShortBigHedgeFactory::CreateFullTradePool(ConstructParameters *InputParameters) {
   ...
   FullTradePool.AddOneTimeRequest(BaseEntryBoundary, SellRawMarketOrderRequest(0.02));
   ...
   FullTradePool.AddOneTimeRequest(DownsideHedgeTakeProfitBoundary, BuyLimitOrderRequest(0.02, GetSpreadOffsetBuyOrderPriceEntry(GetNLevelPrice(InputParameters, LEVEL_OUT_OF_BOUND))));
   ...
   FullTradePool.AddOneTimeRequest(OutOfBoundStopLossBoundary, SellStopOrderRequest(0.02, GetNLevelPrice(InputParameters, LEVEL_OUT_OF_BOUND)));
   ...
   FullTradePool.AddOneTimeRequest(StopLossBoundary, BuyStopOrderRequest(0.04, InputParameters.GetStopLossLevel()));
