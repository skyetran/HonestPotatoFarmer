...
ConstructFullTradePool *SevenLevelNetShortBigHedgeFactory::CreateFullTradePool(ConstructParameters *InputParameters) {
   ...
   FullTradePool.AddOneTimeRequest(BaseEntryBoundary, SellRawMarketOrderRequest(0.07, UniqueFactoryComment + BHS_UNIQUE_COMMENT_01));
   ...
   FullTradePool.AddRecurrentRequest(BaseEntryBoundary, BuyRawMarketOrderRequest(MIN_LOT_SIZE, UniqueFactoryComment + BHS_UNIQUE_COMMENT_15), BaseExitBoundary7);
