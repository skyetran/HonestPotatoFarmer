...
ConstructFullTradePool *SixLevelNetLongBigHedgeFactory::CreateFullTradePool(ConstructParameters *InputParameters) {
   ...
   FullTradePool.AddRequest(OutOfBoundTakeProfitBoundary, SellLimitOrderRequest(0.06, GetNLevelPrice(InputParameters, LEVEL_OUT_OF_BOUND)));
   ...
   FullTradePool.AddRequest(OutOfBoundStopLossBoundary, BuyStopOrderRequest(0.06, GetSpreadOffsetBuyOrderPriceEntry(GetNLevelPrice(InputParameters, LEVEL_OUT_OF_BOUND))));
