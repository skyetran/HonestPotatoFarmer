...
ConstructFullTradePool *SevenLevelNetLongFreeStylingFactory::CreateFullTradePool(ConstructParameters *InputParameters) {
   ...
   FullTradePool.AddOneTimeRequest(BaseEntryBoundary, BuyRawMarketOrderRequest(GetCoveredAllCoveredRetracementLotSize(InputParameters, SEVEN_LEVEL), UniqueFactoryComment + FSL_UNIQUE_COMMENT_01));
   ...
   FullTradePool.AddRecurrentRequest(BaseEntryBoundary, BuyRawMarketOrderRequest(GetCoveredRetracementLotSizeNLevel(LEVEL_FIVE , InputParameters), UniqueFactoryComment + FSL_UNIQUE_COMMENT_13), BaseExitBoundary6);
   ...
   FullTradePool.AddRecurrentRequest(BaseEntryBoundary, BuyRawMarketOrderRequest(GetCoveredRetracementLotSizeNLevel(LEVEL_SIX  , InputParameters), UniqueFactoryComment + FSL_UNIQUE_COMMENT_15), BaseExitBoundary7);
